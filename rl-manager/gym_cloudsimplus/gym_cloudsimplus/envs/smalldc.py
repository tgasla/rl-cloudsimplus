...
0: does nothing
1: create a SMALL VM
2: remove a random SMALL VM
3: create a MEDIUM VM
4: remove a random MEDIUM VM
5: create a LARGE VM
6: remove a random LARGE VM 
...
class SmallDC(gym.Env):
    ...
    def render(self):
        ...
        # TODO: maybe render should pass also the metric names
