...
public class VmAllocationPolicyCustom extends VmAllocationPolicySimple {
    ...
    public HostSuitability allocateHostForVm(final Vm vm) {
        ...
        // allocated
        // vm desctiption example: "S-13". We parse the description getting the number after the '-'
        // symbol
        // and after the allocation is done we set the description back to the vm type only (i.e.
        // "S")
